System.register(['angular2/core', './character', './character.component'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            CharacterListComponent = (function () {
                function CharacterListComponent() {
                    this.characters = [
                        new character_1.Character(1, 'Hello'),
                        new character_1.Character(2, 'Hi')
                    ];
                }
